...
def init_dataset(cfg_dataset: dict) -> Tuple[Dataset, Dataset, Dataset]:  
  ...
  match cfg_dataset["name"]: 
    case "mnist": 
      ...
      train_ds, push_ds, val_ds, test_ds = mnist(cfg_dataset) 
    case "fashion_mnist": 
      print("Loading dataset: Fashion MNIST")
      train_ds, push_ds, val_ds, test_ds = fashion_mnist(cfg_dataset) 
    case "cifar10":
      print("Loading dataset: CIFAR10")
      train_ds, push_ds, val_ds, test_ds = cifar10(cfg_dataset) 
    case "cifar100":
      print("Loading dataset: CIFAR100")
      train_ds, push_ds, val_ds, test_ds = cifar100(cfg_dataset) 
    case "svhn": 
      print("Loading dataset: SVHN")
      train_ds, push_ds, val_ds, test_ds = svhn(cfg_dataset) 
    case "celeba": 
      print("Loading dataset: CelebA")
      train_ds, push_ds, val_ds, test_ds = celebA(cfg_dataset) 
    case "flowers102": 
      print("Loading dataset: Flowers102")
      train_ds, push_ds, val_ds, test_ds = flowers102(cfg_dataset)
    case "two_gaussians": 
      print("Loading dataset: Two Gaussians")
      train_ds, push_ds, val_ds, test_ds = two_gaussians(cfg_dataset)
    case "four_gaussians": 
      print("Loading dataset: Four Gaussians")
      train_ds, push_ds, val_ds, test_ds = four_gaussians(cfg_dataset)
    case "moons": 
      print("Loading dataset: Moons")
      train_ds, push_ds, val_ds, test_ds = moons(cfg_dataset)
    case "circles": 
      print("Loading dataset: Concentric Circles")
      train_ds, push_ds, val_ds, test_ds = circles(cfg_dataset)
    case "s_curve": 
      print("Loading dataset: S Curve")
      train_ds, push_ds, val_ds, test_ds = s_curve(cfg_dataset)
    case "cars": 
      print("Loading dataset: Stanford Cars")
      train_ds, push_ds, val_ds, test_ds = cars(cfg_dataset)
    case "shakespeare":
      print("Loading dataset: Shakespeare")
      train_ds, push_ds, val_ds, test_ds = shakespeare(cfg_dataset)
    case "cub200": 
      print("Loading dataset: CUB200")
      train_ds, push_ds, val_ds, test_ds = cub200(cfg_dataset)
    case "inaturalist": 
      print("Loading dataset: iNaturalist")
      train_ds, push_ds, val_ds, test_ds = inaturalist(cfg_dataset)
    case _: 
